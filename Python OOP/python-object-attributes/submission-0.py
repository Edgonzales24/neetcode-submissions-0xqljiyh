...
print("Initial Attributes: " + whiskers.name, "(" + whiskers.species + ")", 
      "- Hunger: " + str(whiskers.hunger) + ",", "Energy: " + str(whiskers.energy))
...
print("Modified Attributes: " + whiskers.name, "(" + whiskers.species + ")", 
      "- Hunger: " + str(whiskers.hunger) + ",", "Energy: " + str(whiskers.energy))